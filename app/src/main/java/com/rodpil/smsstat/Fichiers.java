...
public class Fichiers {
    ...
    public static List<Contact> JSONParser(Context _context, String filename) throws IOException, JSONException {
        List<Contact> listPerson = new ArrayList<>();
        ...
        for (int i = 0; i < contacts.length(); i++) {
            ...
            listPerson.add(new Contact(name,phone, counter));
        } return listPerson;
    }
